...
class MyApp extends connect(store)(LitElement) {
  ...
  render() {
    ...
    return html `
      <!-- Header -->
      <firebase-app auth-domain="stennifer-0.firebaseapp.com"
        database-url="https://stennifer-0.firebaseio.com"
        api-key="AIzaSyDnTXR3p46lZ2hdG4hvv6TmTU6YXOsOeTs"
        storage-bucket="stennifer-0.appspot.com"
        messaging-sender-id="946338578328"></firebase-app>
